...
./configure --without-libxml2 --without-libexpat --without-sqlite3 --enable-libaria2 --without-zlib --without-libcares --without-libgmp --without-libnettle --enable-static --disable-shared ARIA2_STATIC=yes --without-libssh2 --disable-metalink --disable-websocket --disable-nls
